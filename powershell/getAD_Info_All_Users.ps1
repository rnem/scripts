...
@{Label="Market";Expression={ if( $_.CanonicalName.Split("/")[2].IndexOf("AMS") -gt -1  -Or $_.CanonicalName.Split("/")[2].IndexOf("AOA") -gt -1  -Or $_.CanonicalName.Split("/")[2].IndexOf("EUR") -gt -1 -Or $_.CanonicalName.Split("/")[2].IndexOf("TECHM") -gt -1 -Or $_.CanonicalName.Split("/")[2].IndexOf("Company") -gt -1 ){ $_.CanonicalName.Split("/")[2] }else{ 'N/A' }   }},
...
@{Label="Company E-mail?";Expression={ if( $_.EmailAddress.ToLower().IndexOf("company.") -gt -1) { 'YES' } else { 'NO' } }},
