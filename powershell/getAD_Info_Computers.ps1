###########################################################
# Extract information of computer from Active Directory   #
# by Roger Nem (2015)                                     #
#                                                         #
# History:                                                #
...
Get-ADComputer -Filter * -Properties Name,DistinguishedName,Created | Select $Headers | export-csv "E:\AD_Extract\data\AD_Export_Computers.csv" -NoTypeInformation -Encoding UTF8
