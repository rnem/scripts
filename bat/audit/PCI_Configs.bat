...
REM https://github.com/jbarcia/PCI-Audit-Script/blob/master/PCI_Configs.bat
...
echo:
	...
	echo --------------------------------------------------
		...
		netstat â€“r >> "%tempdir%\Req 2\2.2.2 %Hostname% Listening Services 2.txt"
		netstat â€“nabo >> "%tempdir%\Req 2\2.2.2 %Hostname% Listening Services 3.txt"
	...
	echo --------------------------------------------------
		...
		net group â€œEnterprise Adminsâ€ /domain >> "%tempdir%\Req 8\8.1 %Hostname% Enterprise Administrators.txt" 
		net group â€œDomain Controllersâ€ /domain >> "%tempdir%\Req 8\8.1 %Hostname% Domain Controllers.txt"  
	echo --------------------------------------------------
